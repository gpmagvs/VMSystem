    ...
    public class GPMForkAGVVMSEntity : IVms
    {
        ...
        public GPMForkAGVVMSEntity()
        {
            AGVList = new Dictionary<string, IAGV>()
             {
                 {"AGV_1",new clsGPMForkAGV("AGV_1", new clsConnections { HostIP = "192.168.0.101", HostPort = 7025 },9,simulationMode:true) },
                 {"AGV_2",new clsGPMForkAGV("AGV_2", new clsConnections { HostIP = "192.168.0.102", HostPort = 7025 },21,simulationMode:true )},
